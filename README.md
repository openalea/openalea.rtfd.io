...
OpenAlea is licensed under the [CeCILL-C](https://www.cecill.info/licences/Licence_CeCILL-C_V1-en.html) free software license agreement.
...
You can find examples of what can be done with **OpenAlea** in the [Gallery](https://openalea.readthedocs.io/en/latest/tutorials/index.html) page.
